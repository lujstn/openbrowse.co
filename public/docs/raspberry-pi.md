...
*Source: https://openbrowse.co/docs/raspberry-pi*
...
Every figure on the [benchmarks page](https://openbrowse.co/benchmarks) was measured on a Raspberry Pi 5 with 16GB of RAM running 64-bit Debian, against a hosted service running in a datacentre. Nothing was scaled down for the occasion, and the Pi was not the slow side of that comparison.
...
**An API key**, from OpenAI or Anthropic. This is the only recurring cost of running OpenBrowse, and it is worth reading [what a run actually costs](https://openbrowse.co/docs/cost) before you pick a model, because the spread between the cheapest and dearest configuration is wider than most people expect.
