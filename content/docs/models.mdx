...
`DEFAULT_MODEL` in the instance's `.env` decides which of the eight a request that names none gets, and it is editable from the dashboard's Settings page. [Installation](/docs/installation#configuration) lists it alongside every other variable.
