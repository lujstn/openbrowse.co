...
```json
{
  ...
  "message": "Session is running, not idle",
  "resolution": "Wait for the session to reach a terminal state, or start a new session for this task.",
...
| `404` | `ENDPOINT_NOT_FOUND` | The route or method does not exist under `/v3`. |
