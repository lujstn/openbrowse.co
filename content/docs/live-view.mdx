...
| `completion` | The final delivery line. When a schema-valid result arrives despite the agent expressing doubt, the line reports completion and preserves the agent's reason after `The agent noted:` |
